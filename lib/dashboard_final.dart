...
import 'nsrc_report_screen.dart';
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const NsrcReportScreen()),
                      );
                    },
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text(_screenShieldActive ? '🛡️ Screen protection deactivated' : '🛡️ Screen protection activated')),
                      );
                    },
                    ...
                    TextField(
                      ...
                      decoration: const InputDecoration(
                        hintText: _kindergartenMode 
                          ? 'Paste message here to check if it\'s safe'
  ...
  void _analyzeSMS() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(isScam ? '⚠️ SCAM DETECTED' : '✅ Message Appears Safe'),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(
